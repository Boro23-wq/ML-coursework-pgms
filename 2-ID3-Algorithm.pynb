# importing pandas (high-level data manipulation)
import pandas as pd
# importing DataFrame (data structure)
...
def entropy_of_list(a_list):
    ...
    cnt = Counter(
        x for x in a_list)  # Counter calculates the propotion of class
    # print("\nClasses:",cnt)
...
def classify(instance, tree,
             default=None):  # Instance of Play Tennis with Predicted
